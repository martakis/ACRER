#' #' NGroup3 computes the group numbers of recreation areas.
#'
...
#' @return list33 Nfactors, Fbfact11, Fbfact22, Ngroups, levels_sr, Index_group_number.
...
NGroup3 <- function(nRowMatrix, activ_segment, c1, c2, sumc1c2, sumc1, levels_sr, Index_group_number,
    ...
    if (nRowMatrix == 1) {
        ...
        sumcgroups4 <- sumc1c2[(pos1[3] + 1):nc1c2]
        c41 <- c1[(pos1[3] + 1):nc1c2]
        c42 <- c2[(pos1[3] + 1):nc1c2]
        activ_segment4 <- activ_segment[, (pos1[3] + 1):nc1c2]
        sumcgroups <- sumc1c2
        v12 <- 0
        v13 <- 0
        v14 <- 0
        ...
        if (g4 == g4) {
            ...
            Cc41 <- c41
            Cc42 <- c42
            if ((v12 == 1) | (v13 == 1) | (v14 == 1) | (v23 == 1) | (v24 == 1) | (v34 ==
                1)) {
                cmb4 <- 9999
            } else {
                cmb4 <- 0
        ...
        if ((sizecombined3 == q) & (cmb3 == 1)) {
            ...
            g3 <- intersect(rowsumactivesegment1, rowsumactivesegment)
            lg3 <- length(g3)
            if (lg3 > 0) {
                fRecrIDX1 <- fRecrIDX
                fRecrIDX1 <- fRecrIDX1[d4]
        ...
        list33 <- list(Nfactors, FRecrID, Ngroups, levels_sr, Index_group_number)
        ## end if nRowMatrix == 1
    } else {
        ...
        if (g4 == g4)
            {
                activsegment4 <- c(activ_segment4)
                combined4 <- sumcgroups4
                sizecombined4 <- length(sumcgroups4)
                Cc41 <- c(c41)
                if ((v12 == 1) | (v13 == 1) | (v14 == 1) | (v23 == 1) | (v24 == 1) |
                  (v34 == 1)) {
                  cmb4 <- 9999
                } else {
                  cmb4 <- 0
        ...
        if (((sizecombined1 + sizecombined3) == q) & (cmb1 == 0) & (cmb2 == 0)) {
            activsegment13 <- cbind(activsegment1, activsegment3)
            dd <- data.frame(activsegment13)
            d4 <- apply(dd, 1, function(row) all(row != 0))
            activsegment13 <- as.matrix(dd[d4, ])
        ...
        if (((sizecombined1 + sizecombined4) == q) & (cmb1 == 1) & (cmb2 == 1)) {
            activsegment14 <- cbind(activsegment1, activsegment4)
            dd <- data.frame(activsegment14)
            d4 <- apply(dd, 1, function(row) all(row != 0))
            activsegment14 <- as.matrix(dd[d4, ])
        ...
        if (((sizecombined1 + sizecombined4) == q) & (cmb1 == 1) & (cmb2 == 0)) {
            activsegment14 <- cbind(activsegment1, activsegment4)
            dd <- data.frame(activsegment14)
            d4 <- apply(dd, 1, function(row) all(row != 0))
            activsegment14 <- as.matrix(dd[d4, ])
        ...
        if (((sizecombined1 + sizecombined4) == q) & (cmb1 == 0) & (cmb2 == 1)) {
            activsegment14 <- cbind(activsegment1, activsegment4)
            dd <- data.frame(activsegment14)
            d4 <- apply(dd, 1, function(row) all(row != 0))
            activsegment14 <- as.matrix(dd[d4, ])
        ...
        if (((sizecombined1 + sizecombined4) == q) & (cmb1 == 0) & (cmb2 == 0)) {
            activsegment14 <- cbind(activsegment1, activsegment4)
            dd <- data.frame(activsegment14)
            d4 <- apply(dd, 1, function(row) all(row != 0))
            activsegment14 <- as.matrix(dd[d4, ])
        ...
        list33 <- list(Nfactors, Fbfact11, Fbfact22, Ngroups, levels_sr, Index_group_number)

    }
    ## end if ngroups == 3 (the number of ngroups equals to 4)
    return(list33)
}
